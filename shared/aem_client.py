...
import logging
import os
from shared.models import Asset, Folder, BulkUpdateResult
from shared.constants import AEM_API_ENDPOINT, AEM_FOLDERS_ENDPOINT, AEM_CLASSIC_API_ENDPOINT, ADOBE_IMS_TOKEN_ENDPOINT, AEM_SCOPES
...
class AEMAssetsClient:
    ...
    def __init__(self, config: AEMConfig):
        ...
        if config.service_account_json_path:
            try:
                from shared.jwt_auth import JWTServiceAccountAuth
